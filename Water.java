...
/**
 * The Water class represents a Water-type Pokémon.
 */
public class Water implements Pokemon {
    ...
    /**
     * Constructs a Water-type Pokémon with the specified name, hp, attack, and list of attacks.
     *
     ...
     */
    public Water(String name, int hp, int attack, List<Attack> attacks) {
        this.name = name;
        this.hp = hp;
        this.attack = attack;
    ...
    public String getDescription() {
        return "Water-type Pokémon are known for their strength and ability, they destroy Fire-type Pokémon but have disadvantages against Grass.";
    }
